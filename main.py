...
token = '6021069050:AAHcVEM1Yn1nalUYmU0f2x9slZ9ndmm352Y'
...
def phone(message):
 ...
 - اضغط على الزر ادناه لكي اتحقق ذلك ...''', reply_markup = keyboard)
   ...
   bot.reply_to(message,'- تم اعطائك محاولتين لزيادة المحاولات راسل المطور @Huks3')
...
عبدالعزيز (عبد)
==============================
للمساعدة يرجى التواصل مع المطور : @HUKS3
استمتعوا (؛''')
